...
int main(int argc, char** argv)
{
    ...
    
    {
        ...
        auto pDefaultShaderProgram = resourceManager
            .loadShaders("default_shader", "res/shaders/vertex.txt", "res/shaders/fragment.txt");

        if (!pDefaultShaderProgram)
        {
            std::cerr << "Can't load shader program: " << "default_shader" << std::endl;
            return -1;
        }
